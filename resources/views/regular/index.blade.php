       ...
       <div class="container-fluid p-0 mb-5">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                <img class="carousel_img" src="{{ asset("assets/regular/img/carousel-1.jpg") }}" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Point d'Accès du Futur</h5>
                                <h1 class="display-3 text-white animated slideInDown">Formez Vous Par Des Expert</h1>
                                <p class="fs-5 text-white mb-4 pb-2">Gagnez non seulement en compétences techniques mais aussi en soft skills grâce à l'aasistance de formateurs qualifiés.</p>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Voir Plus</a>
                                <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Démarrer</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-carousel-item position-relative">
                <img class="carousel_img" src="{{ asset("assets/regular/img/carousel-2.jpg") }}" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <p class="fs-5 text-white mb-4 pb-2">Plus bésoin de vous déplacer pour suivre vos cours. Tout est fait en ligne ainsi vous pouvez suivre vos cours n'importe où.</p>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Voir Plus</a>
                                <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Démarrer</a>
                            </div>
                        </div>
